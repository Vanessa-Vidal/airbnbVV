...
SELECT listings.property_type, COUNT(reviews.id), max(date_reviewed) FROM listings INNER JOIN reviews ON listings.id=reviews.listing_id GROUP BY listings.property_type;
